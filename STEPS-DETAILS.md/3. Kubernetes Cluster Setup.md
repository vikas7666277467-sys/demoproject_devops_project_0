...
# Step 2 - Set Hostnames If not updated yet .
...
# Next Section - Installing Kubernetes Components & Initializing the Control Plane
...
# Next Section : we are Joining Worker Nodes, Installing Calico CNI & Verifying the Kubernetes Cluster
